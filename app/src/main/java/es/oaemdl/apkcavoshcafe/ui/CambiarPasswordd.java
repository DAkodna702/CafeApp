...
import es.oaemdl.apkcavoshcafe.databinding.FragmentCambiarPassworddBinding;

public class CambiarPasswordd extends Fragment {
    FragmentCambiarPassworddBinding binding;
    View view;
    Context context;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        binding = FragmentCambiarPassworddBinding.inflate( inflater, container, false );
